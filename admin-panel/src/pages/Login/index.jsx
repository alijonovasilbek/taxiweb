        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 12, color: '#94a3b8', marginTop: 6 }}>
              Telegram ID ADMIN_TELEGRAM_IDS ro'yxatida bo'lishi kerak
            </p>
          </div>
          ...
          <button
            ...
            style={{
              ...
              background: loading || !telegramId ? '#cbd5e1' : '#2563EB',
              color: '#fff', border: 'none', borderRadius: 10, cursor: loading || !telegramId ? 'default' : 'pointer',
            }}
          >
